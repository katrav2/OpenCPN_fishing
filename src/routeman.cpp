...
void WayPointman::ProcessIcons( ocpnStyle::Style* style )
{
    ...
    ProcessIcon( style->GetIcon( _T("casier") ), _T("casier"), _T("Casier") );
    ProcessIcon( style->GetIcon( _T("maquereau") ), _T("maquereau"), _T("Maquereaux") );
    ProcessIcon( style->GetIcon( _T("dorade") ), _T("dorade"), _T("Dorades") );
    ProcessIcon( style->GetIcon( _T("lignefond") ), _T("lignefond"), _T("Ligne de fond") );
    ProcessIcon( style->GetIcon( _T("rocher") ), _T("rocher"), _T("Rocher") );
    ProcessIcon( style->GetIcon( _T("roche_danger") ), _T("roche_danger"), _T("Roche_danger") );
